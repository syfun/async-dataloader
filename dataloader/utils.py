...
def sort(keys: Sequence[KeyT], values: Sequence[ValueT], *, key_fn: KEY_FUNCTION[ValueT, KeyT]) -> List[ValueT]:
    """
...
def group_sort(keys: Sequence[KeyT], values: Sequence[ValueT], *, key_fn: KEY_FUNCTION[ValueT, KeyT]) -> List[Any]:
    """
